...
export function NewMemoryForm() {
  ...
  async function handleCreateMemory(event: FormEvent<HTMLFormElement>) {
    event.preventDefault() // nao leva o user para outra pagina

    const formData = new FormData(event.currentTarget) // pega todos os dados do formulario enviado
    ...
    // salva a memoria no banco de dados
    await api.post(
      '/memories',
      {
        coverUrl,
